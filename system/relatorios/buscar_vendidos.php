            ...
            <div class="4 large-4 columns" style="border:0px solid #000; ">
                <label>
                    ...
                    <select style="width:13em;" id="mes" name="mes" >
                    	...
                    	<?php
						$sql = "select distinct substring(dt_baixa,5,2) mes from produto where dt_baixa is not null group by substring(dt_baixa,5,2)";
            ...
            <div class="4 large-4 columns" style="border:0px solid #000; ">
                <label>
                    <select style="width:13em;" id="ano" name="ano">
                    	...
                    	<?php
						$sql = "select distinct substring(dt_baixa,1,4) ano from produto where dt_baixa is not null";
