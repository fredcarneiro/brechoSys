...
$(document).ready(function() {
	...
	$(document.body).on('click', '.baixaParcela' , function() {	
		...
		$.post(
			'crud.php',
			{p_id: p_id, ac: 'baixaParcela', baixa: baixa},
...
?>
<form id="formBusca">
	<input type="hidden" id="ac" name="ac" value="a_receber" /> 
            ...
            <div class="4 large-4 columns" style="border:0px solid #000; ">
                <label>
                    ...
                    <select style="width:13em;" id="mes" name="mes" >
                    	...
                    	<?php
						$sql = "select distinct substring(dt_vencimento,5,2) mes from pagamento order by substring(dt_vencimento,5,2)";
            ...
            <div class="4 large-4 columns" style="border:0px solid #000; ">
                <label>
                    <select style="width:13em;" id="ano" name="ano">
                    	...
                    	<?php
						$sql = "select distinct substring(dt_vencimento,1,4) ano from pagamento";
    ...
    <fieldset style="border:1px solid #000; width:800px; margin:auto;">
        ...
        <div class="row" style="border:0px solid #000;">     
            <div class="twelve large-12 columns" style="border:0px solid #000;text-align:center; " id="result_busca">
