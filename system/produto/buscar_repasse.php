...
?>
<form id="formBusca" method="post" action="produtos_repasse.php">
    ...
    <div class="row" style="padding-top: 1.563em;">
        <div class="twelve large-12 columns" style="padding-bottom:2em;  padding-left:0px; text-align:center; font-weight:bold;">
            BUSCA DE PRODUTOS COM VALOR REPASSADO POR USU&Aacute;RIO
        </div>
    </div>
            ...
            <div class="4 large-4 columns" style="border:0px solid #000; ">
                <label>
                    ...
                    <select style="width:13em;" id="mes" name="mes" >
                    	...
                    	<?php
						$sql = "select distinct substring(dt_repasse,5,2) mes from produto where dt_repasse is not null and dt_baixa is not null and usuario_id_usuario = $id_usuario group by substring(dt_baixa,5,2)";
            ...
            <div class="4 large-4 columns" style="border:0px solid #000; ">
                <label>
                    <select style="width:13em;" id="ano" name="ano">
                    	...
                    	<?php
						$sql = "select distinct substring(dt_repasse,1,4) ano from produto where dt_repasse is not null and dt_baixa is not null and usuario_id_usuario = $id_usuario ";
